...
import { certificates, education } from '../data/portfolioData';
    ...
    <section className="bg-[#ff2a2a] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-12">
          <h3 className="text-2xl md:text-3xl font-black text-black mb-6 tracking-tight text-center uppercase">
            Education
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/25 transition-all duration-500">
              <div className="flex items-start gap-4">
                <span className="text-2xl mt-0.5">🎓</span>
                <div>
                  <h4 className="text-white font-bold text-base leading-tight mb-1">{education.degree}</h4>
                  <p className="text-white/70 text-sm font-semibold">{education.institution}</p>
                  <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mt-1">Expected {education.graduation}</p>
                </div>
              </div>
            </div>
            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/25 transition-all duration-500">
              <div className="flex items-start gap-4">
                <span className="text-2xl mt-0.5">⚡</span>
                <div>
                  <h4 className="text-white font-bold text-base leading-tight mb-1">BTech – Electrical, Electronics & Communications Engineering</h4>
                  <p className="text-white/70 text-sm font-semibold">Vellore Institute of Technology</p>
                  <p className="text-white/50 text-xs font-semibold uppercase tracking-wider mt-1">2018 – 2022</p>
                </div>
              </div>
            </div>
          </div>
