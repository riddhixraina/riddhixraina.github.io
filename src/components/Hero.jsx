...
import heroPoster from '../assets/hero video/riddhi-hero-poster.jpg';
import { heroContent, personalInfo, socialLinks } from '../data/portfolioData';

// Optional hero video: drop any .mp4 into src/assets/hero video/
// (e.g. a Veo-generated talking avatar) and it will be picked up automatically.
const heroVideoModules = import.meta.glob('../assets/hero video/*.mp4', { eager: true });
const heroVideo = Object.values(heroVideoModules)[0]?.default || null;
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      {/* Background Video (falls back to hero image until a video is added) */}
      {heroVideo ? (
        <video
          ref={videoRef}
          loop
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.email} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#ff2a2a]" aria-label="Email">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884zM18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>
            </a>
          </div>
          ...
          >
            ...
            <span className="block mt-2 text-4xl md:text-6xl lg:text-7xl font-black text-[#ff2a2a] drop-shadow-[0_2px_16px_rgba(0,0,0,0.9)] leading-tight">
        ...
        {/* Right Side: Play Video Button (only when a hero video is present) */}
        {heroVideo && (
        <div 
          data-aos="zoom-in"
          data-aos-delay="600"
